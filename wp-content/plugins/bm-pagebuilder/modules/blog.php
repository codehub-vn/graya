	...
	if($module_post){
		...
		switch($type){
			case 'masonry_list':
                ...
                <div class="row-fluid blog-masony-wrap">
												...
												case 'soundcloud': ?>
													<div class="soundcloudWrapper">
							                            <?php if($ux_audio_soundcloud){ ?>
							                                <iframe width="100%" height="166" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=<?php echo esc_url($ux_audio_soundcloud); ?>&amp;color=ff3900&amp;auto_play=false&amp;show_artwork=false"></iframe>
							                            <?php } ?>
								                    </div>
								                    <div class="item_des">
								                        <div class="date-block">
                                                ...
                                                <div class="video-face">
                                                    ...
                                                    <?php }elseif(strstr($ux_video_embeded_code, "vimeo") && !(strstr($ux_video_embeded_code, "iframe"))){ ?>
                                                        <div class="videoWrapper vimeo video-wrap hidden">
                                                            <iframe src="http://player.vimeo.com/video/<?php echo esc_attr(ux_theme_get_vimeo($ux_video_embeded_code)); ?>?title=0&amp;byline=0&amp;portrait=0&amp;autoplay=0" width="100%" height="auto" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
                                                        </div>
                                                    <?php }else{
