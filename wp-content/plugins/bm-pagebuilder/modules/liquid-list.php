                                        ...
                                        <div class="video-face">
											...
											if(strstr($ux_video_embeded_code, "youtu") && !(strstr($ux_video_embeded_code, "iframe"))){ ?>
                                                ...
                                                <div class="videoWrapper video-wrap hidden" style="padding-bottom:49%">
                                                    <iframe src="http://player.vimeo.com/video/<?php echo ux_theme_get_vimeo($ux_video_embeded_code); ?>?title=0&amp;byline=0&amp;portrait=0&amp;autoplay=0" width="100%" height="auto" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
                                                </div>
                                                <?php }else{ ?>
                                                <div class="videoWrapper video-wrap hidden">
...
function ux_pb_view_liquid_load($post_id, $block_words, $show_social, $image_ratio){
	...
	<section class="liquid-expand-wrap" style="display:none;">
        ...
        <div class="liquid-more">
	            <a href="<?php the_permalink(); ?>" class="liquid-more-icon ux-btn <?php if($show_social){ echo 'liquid-more-icon-right';} ?>" title="<?php the_title(); ?>"><?php echo esc_html($learnmore); ?></a>
	            <?php if($show_social){ ?>
