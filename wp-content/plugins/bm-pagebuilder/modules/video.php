            ...
            <div class="video-wrap hidden <?php echo sanitize_html_class($video_size); ?>" style=" <?php echo esc_attr($video_custom); ?>">
				<?php if($embed_code){
                    if(strstr($embed_code, "youtu") && !(strstr($embed_code, "iframe"))){ ?>
                        <iframe src="http://www.youtube.com/embed/<?php echo esc_attr(ux_theme_get_youtube($embed_code)); ?>?rel=0&controls=1&showinfo=0&theme=light&autoplay=0&wmode=transparent" width="1500" height="844" frameborder="0" allowfullscreen=""></iframe>
                    <?php
                    }elseif(strstr($embed_code, "vimeo") && !(strstr($embed_code, "iframe"))){ ?>
                        <iframe src="http://player.vimeo.com/video/<?php echo esc_attr(ux_theme_get_vimeo($embed_code)); ?>?title=0&amp;byline=0&amp;portrait=0&amp;autoplay=0" width="1500" height="844" frameborder="0" allowfullscreen=""></iframe>
                    <?php	
                    }else{
