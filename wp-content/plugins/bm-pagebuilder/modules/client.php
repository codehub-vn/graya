...
function ux_pb_module_client($itemid){
	...
	if($module_post){
        ...
        <div class="clients_wrap owl-carousel-pb" data-item="<?php echo esc_attr($data_column); ?>" data-auto="false" data-center="false" data-margin="10" data-autowidth="false" data-slideby="<?php echo esc_attr($data_column); ?>">
