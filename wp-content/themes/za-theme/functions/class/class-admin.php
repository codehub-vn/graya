...
function ux_theme_tgm_register(){
	$plugins = array(
		...
		array(
			...
			'slug' 		=> 'bm-pagebuilder',
			'version'	=> '',
			'source'    => get_stylesheet_directory() . '/functions/plugins/bm-pagebuilder.zip', 
			'required' 	=> true,
		),
		array(
			'name' 		=> 'BM Shortcodes',
			'slug' 		=> 'bm-shortcodes',
			'version'	=> '',
			'source'    => get_stylesheet_directory() . '/functions/plugins/bm-shortcodes.zip', 
			'required' 	=> false,
		),
		array(
			'name' 		=> 'BM Slider',
			'slug' 		=> 'bm-slider-za',
			'source'    => get_stylesheet_directory() . '/functions/plugins/bm-slider-za.zip', 
			'version'	=> '',
			'required' 	=> false,
		)
