...
<div class="shipping-calc span6">

    <form class="shipping_calculator" action="<?php echo esc_url($woocommerce->cart->get_cart_url()); ?>" method="post">
    
        <h4 class="lined-heading" style="cursor: pointer;">
            <span><?php _e('Calculate Shipping', 'woocommerce'); ?></span>
        ...
        <section class="shipping-calculator-form">
            ...
            <p class="form-row form-row-wide">
                <select name="calc_shipping_country" id="calc_shipping_country" class="country_to_state" rel="calc_shipping_state">
                    ...
                    <?php foreach($woocommerce->countries->get_allowed_countries() as $key => $value){
