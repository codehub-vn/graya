...
add_action('woocommerce_before_subcategory_title', 'ux_woocommerce_subcategory_thumbnail', 10);

//Add woocommerce before shop loop item title
add_action('woocommerce_before_shop_loop_item_title', 'ux_woocommerce_template_loop_product_thumbnail', 15);

//Add woocommerce after shop loop
add_action('woocommerce_after_shop_loop', 'ux_interface_pagination', 10);

//Add woocommerce after single product
add_action('woocommerce_after_single_product', 'woocommerce_upsell_display', 15);
add_action('woocommerce_after_single_product', 'woocommerce_output_related_products', 20);

//ux_interface_wc_cart
add_action('ux_interface_wc_cart', 'ux_woocommerce_sidebar_cart');
...
add_filter('woocommerce_product_tabs', 'ux_woocommerce_default_product_tabs', 10);
