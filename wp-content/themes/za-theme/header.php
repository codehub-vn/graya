...
<html <?php language_attributes(); ?>>
  ...
  <body <?php ux_interface_body_class(); ?>>
      ...
      <?php //** Do Hook header
	  /**
	   * @hooked  ux_interface_header - 10
	   */
	  do_action('ux_interface_header'); ?>
		
	  <?php //** Do Hook Content before
      /**
       * @hooked  ux_interface_content_page_cover - 5
       * @hooked  ux_interface_content_page_second_fullwidth - 6
       * @hooked  ux_interface_content_before - 10
       * @hooked  ux_interface_content_titlewrap - 15
       * @hooked  ux_interface_content_slider - 20
       */
